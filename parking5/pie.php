...
$width = 500;
$background_color = 'F0EFE2'; // background-color of the chart...
$text_color = '000000'; // text-color.
$colors = array('9A99FF', '9D3364', 'FF3266','00FF99', 'FF969B', '0066CB','990000','520000','BFBFC1','808080'); // colors of the slices.
...
{
	if ($data[$i]/array_sum($data) < 0.1) $number[$i] = ' '.number_format($data[$i]).' -';
	else $number[$i] = number_format($data[$i]).' -';
